...
from utils.strategy_exec.misc import add_tag_to_trades_and_close_position, log_all_trades
from utils.strategy_exec.partial_close import process_partial_close
...
def process_max_duration(
    ...
    if condition_long or condition_short:
        ...
        logging.debug("Closing position because max dration exceeded...")
        return True
    return False
