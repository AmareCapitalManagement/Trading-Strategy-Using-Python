...
Beyond the markets, we are also avid poker players who apply game theory optimal (GTO) principles to our strategic thinking. This background in competitive poker sharpens our decision-making process, teaching us to navigate uncertainty, manage risk, and exploit inefficiencies with precision. By integrating game-theoretical thinking into our investment process, we develop adaptive strategies designed to outperform across various market regimes.
