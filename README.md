...
Amare Capital Management (Pty) Ltd is a systematic hedge fund specializing in trading and investing in stocks and stock CFDs. We are committed to developing and refining quantitative trading strategies through rigorous statistical analysis and robust backtesting. Our approach focuses on simplifying and enhancing strategy performance, leveraging a Python-based framework to systematically identify and capture market inefficiencies.
