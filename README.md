...
Amare Capital Management (Pty) Ltd is a quantitative investment management firm specializing in trading and investing in stocks and stock derivatives. We are committed to developing and refining systematic trading strategies through rigorous statistical analysis and robust backtesting. Our approach focuses on simplifying and enhancing strategy performance, leveraging a Python-based framework to systematically identify and capitalize on market opportunities.
