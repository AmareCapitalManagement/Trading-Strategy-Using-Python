...
def draw_5_days_avg(ticker: str, interval: str = "15m"):
    """
    Create and save plot 5_d_avg_{ticker}.png, containg OHLC candles and 5 days simple moving average (SMA).
    Usage: avoid buying the dip until the price consolidates above 5 days simple moving average (SMA).
    """
